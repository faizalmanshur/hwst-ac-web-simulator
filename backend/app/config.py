...
INPUT_GROUPS = [
    {
        ...
        "fields": [
            ...
            ["property_source", "Sumber properti refrigeran", "1/2", "1=Excel, 2=CoolProp"],
            ["ac_capacity_pk", "Kapasitas AC", "PK", "Kapasitas nominal unit AC"],
            ["cooling_capacity_per_PK_kW", "Cooling capacity per PK", "kW/PK", "Total Q nominal = PK x kW/PK"],
            ["T_amb_C", "Suhu lingkungan", "°C", "Untuk rugi panas tangki"],
            ["pressure_drop_model", "Model pressure drop", "0/2", "0=off, 2=estimasi per zona"],
            ["pressure_drop_feedback", "Feedback pressure drop", "0/1", "1=mengubah tekanan efektif"],
            ["pressure_drop_roughness_mm", "Roughness pipa", "mm", "Roughness tembaga halus"],
            ["dsh_superheat_margin_C", "Margin superheat DSH murni", "°C", "Batas window DSH murni"],
        ],
    },
    {
        "id": "kompresor",
        ...
        "fields": [
            ...
            ["P_suction_psig", "Tekanan suction kerja", "psig", "Tekanan kerja simulasi"],
            ["P_discharge_psig", "Tekanan discharge kerja", "psig", "Tekanan kerja simulasi"],
            ["suction_superheat_nominal_K", "Superheat nominal suction", "K", "Acuan mdot nominal"],
            ["liquid_subcool_nominal_K", "Subcool nominal liquid", "K", "Acuan mdot nominal"],
    ...
    },
    {
        ...
        "fields": [
            ...
            ["k_tube_hwst_W_mK", "Konduktivitas pipa HWST", "W/m.K", "Tembaga sekitar 385 W/m.K"],
            ["h_water_hwst_W_m2K", "h sisi air tangki", "W/m².K", "Input efektif sisi air"],
            ["Rf_hwst_m2K_W", "Rf fouling HWST", "m²K/W", "0 untuk coil bersih"],
            ["UA_loss_W_K", "UA loss tangki", "W/K", "0 jika rugi panas diabaikan"],
    ...
    },
    {
        ...
        "fields": [
            ...
            ["h_air_cond_W_m2K", "h udara efektif kondensor", "W/m².K", "Input efektif sisi udara"],
            ["Rf_cond_m2K_W", "Rf fouling kondensor", "m²K/W", "0 untuk coil bersih"],
    ...
    },
    {
        ...
        "fields": [
            ["capillary_D_i_mm", "Diameter dalam kapiler", "mm", "Geometri kapiler aktual"],
            ["capillary_length_m", "Panjang kapiler", "m", "Geometri kapiler aktual"],
            ["capillary_coil_factor", "Faktor coil kapiler", "-", "Contoh 0,95"],
            ["capillary_diagnostic_mode", "Mode diagnostik kapiler", "0/1", "1=estimasi mdot kapiler"],
            ["capillary_feedback", "Feedback kapiler", "0/1", "1=mdot/tekanan efektif"],
        ],
    },
    {
        "id": "evaporator",
        ...
        "fields": [
            ...
            ["h_air_evap_W_m2K", "h udara efektif evaporator", "W/m².K", "Input efektif sisi udara"],
            ["Rf_evap_m2K_W", "Rf fouling evaporator", "m²K/W", "0 untuk coil bersih"],
            ...
            ["SHR_manual", "SHR manual evaporator", "0–1", "Qsens = SHR x Qevap"],
        ],
    },
    {
        "id": "volume",
        "title": "Variasi Volume",
        "fields": [
            ["volume_var1_L", "Volume variasi 1", "L", "Skenario volume rendah"],
            ["volume_var2_L", "Volume variasi 2", "L", "Skenario volume tengah"],
            ["volume_var3_L", "Volume variasi 3", "L", "Skenario volume tinggi"],
        ],
    },
]
